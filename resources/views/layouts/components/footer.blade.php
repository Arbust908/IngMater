<footer class="w-full bg-gris-700 text-center px-4 pt-3 pb-20 md:flex md:pb-6 self-end">
    ...
    <section class="flex flex-col justify-center p-2 border-b border-main-100 md:order-3 md:w-1/3 md:border-l md:border-b-0">
        <h4 class="text-base text-main-100 font-bold py-2 uppercase">
            @lang('footer.newsletter')
        </h4>
        <form action="" method="post" id="newsletter">
            @csrf
            <input class="rounded-full px-4 py-2 w-full bg-gray-100 placeholder-gris-500 text-sm mb-4 md:max-w-xs md:mx-auto" type="text" placeholder="@lang('footer.placeholder')" name="email">
            <button class="rounded-full w-full text-center text-gray-100 font-bold px-4 py-2 text-sm bg-main-100 border border-main-200 mb-4 md:max-w-xs md:mx-auto hover:text-main-200 hover:bg-transparent hover:shadow-lg" type="submit">
