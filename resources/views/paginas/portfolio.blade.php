...
<div class="flex flex-col">
    <section
        ...
        <div class="flex flex-col lg:justify-center text-white text-center md:w-1/2 md:mr-auto lg:h-full">
            <h1 class="font-bold leading-normal text-xl uppercase lg:text-xxxl lg:text-left lg:pl-40">
                @lang('portfolio.title')
            </h1>
        </div>
    </section>
    <section class="w-full py-8 px-6 font-bold lg:px-40">
        <p class="text-main-100 text-lg text-center lg:text-left">
