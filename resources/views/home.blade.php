...
<div class="flex flex-col">
    <section
        ...
        style="background-image: url({{ url('img/home.jpg') }}); background-position: top; background-repeat: no-repeat; background-size: cover;">
            {{-- Creo que en blanco va a quedar mejor --}}
        <h1 class="font-bold leading-normal text-xl uppercase">
            @lang('home.title')
        </h1>
        <p class="px-6 text-base leading-tight">@lang('home.subtitle')</p>
    </section>
